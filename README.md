...
This paradigm is closely coupled with the POF (page object factory) pattern, but is geared torwards the state management of a given website or web application.
